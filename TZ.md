...
* **Сценарий 1: Сравнение видеокарт для конкретной игры**
  ...
  - Система отображает таблицу с видеокартами из алгоритма рекомендаций и их производительностью (FPS), ценой в рублях и FPS на 1000 рублей
...
*Последнее обновление: 19.01.26 1:56